              ...
              <table class="table-wrap table-input width-full table-read">
                <tbody v-for="(item,index) in list ">
                  ...
                  <tr>
                    <td class='th5'>操作</td>
                    <td>
                      <a href="javascript:;" class="weui-btn weui-btn_mini weui-btn_primary" v-bind:id="item.ID" @click="chuzhi">现场处置</a>
                      <a href="javascript:;" class="weui-btn weui-btn_mini weui-btn_primary" v-bind:id="item.ID" @click="nochuzhi"
                        style="background: #184266;">非现场处置</a>
                    </td>
                  </tr>
                  <!--事件状态-->
                  <tr></tr>
    ...
    methods: {
      ...
      getData() {
        let data = {
          ...
          //"Category":Category,      //类型ID
          //"Level":Level,           //严重级别
          //"Status":Status,        //事件状态，（0，1，2，3，4，-1）
          //"DateS":DateS,          //起始日期
          //"DateE":DateE,          //截止日期
